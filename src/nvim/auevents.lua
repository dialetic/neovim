return {
  events = {
    ...
    'VisualChange',           -- when changing between Visual/Select modes
    'VisualEnter',            -- just after entering Visual/Select mode
    'VisualLeave',            -- just after leaving Visual/Select mode
